...
#ifdef OPENCV
// When included in CUDA files within extern "C" blocks, we can't include OpenCV headers
// as they include C++ standard library headers. Just forward declare the types we need.
#ifdef __NVCC__
